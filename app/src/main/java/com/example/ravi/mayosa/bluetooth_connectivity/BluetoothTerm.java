...
public class BluetoothTerm extends Activity {
    ...
    private List<com.example.ravi.mayosa.bluetooth_connectivity.Message> messageList = new ArrayList<com.example.ravi.mayosa.bluetooth_connectivity.Message>();

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_bluetooth_term);
    ...
    // The Handler that gets information back from the BluetoothComService
